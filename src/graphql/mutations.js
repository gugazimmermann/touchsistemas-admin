...
export const createOwner = /* GraphQL */ `
	mutation CreateOwner($input: CreateOwnerInput!, $condition: ModelOwnerConditionInput) {
...
export const updateOwner = /* GraphQL */ `
	mutation UpdateOwner($input: UpdateOwnerInput!, $condition: ModelOwnerConditionInput) {
...
export const createUserInfo = /* GraphQL */ `
	mutation CreateUserInfo($input: CreateUserInfoInput!, $condition: ModelUserInfoConditionInput) {
...
export const updateUserInfo = /* GraphQL */ `
	mutation UpdateUserInfo($input: UpdateUserInfoInput!, $condition: ModelUserInfoConditionInput) {
...
export const deleteUserInfo = /* GraphQL */ `
	mutation DeleteUserInfo($input: DeleteUserInfoInput!, $condition: ModelUserInfoConditionInput) {

...
export const listOwners = /* GraphQL */ `
	query ListOwners($filter: ModelOwnerFilterInput, $limit: Int, $nextToken: String) {
...
export const syncOwners = /* GraphQL */ `
	query SyncOwners($filter: ModelOwnerFilterInput, $limit: Int, $nextToken: String, $lastSync: AWSTimestamp) {
		syncOwners(filter: $filter, limit: $limit, nextToken: $nextToken, lastSync: $lastSync) {
			items {
				name
				phone
				email
...
export const listUserInfos = /* GraphQL */ `
	query ListUserInfos($filter: ModelUserInfoFilterInput, $limit: Int, $nextToken: String) {
...
export const syncUserInfos = /* GraphQL */ `
	query SyncUserInfos($filter: ModelUserInfoFilterInput, $limit: Int, $nextToken: String, $lastSync: AWSTimestamp) {
		syncUserInfos(filter: $filter, limit: $limit, nextToken: $nextToken, lastSync: $lastSync) {
			items {
				id
				phone
				name

...
export declare class Client {
	...
	static copyOf(
		source: Client,
		mutator: (draft: MutableModel<Client, ClientMetaData>) => MutableModel<Client, ClientMetaData> | void
	): Client;
}
...
export declare class Event {
	...
	static copyOf(
		source: Event,
		mutator: (draft: MutableModel<Event, EventMetaData>) => MutableModel<Event, EventMetaData> | void
	): Event;
}
...
export declare class UserInfo {
	...
	static copyOf(
		source: UserInfo,
		mutator: (draft: MutableModel<UserInfo, UserInfoMetaData>) => MutableModel<UserInfo, UserInfoMetaData> | void
	): UserInfo;
}
